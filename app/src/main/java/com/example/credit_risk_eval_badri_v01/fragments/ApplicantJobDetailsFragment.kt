...
class ApplicantJobDetailsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_applicant_job_details, container, false)
        ...
        et4 = view.findViewById(R.id.etField)
        et5 = view.findViewById(R.id.etExperience)
        et6 = view.findViewById(R.id.etpreviousctc)
        et7 = view.findViewById(R.id.etcurrentctc)
        et8 = view.findViewById(R.id.etskills)
        et9 = view.findViewById(R.id.etworkinghours)
        et10 = view.findViewById(R.id.etadditionalinfo)
...
//        }
    ...
    private fun initializeData(){
        jobType = arguments?.getString("jobType")!!
    ...
    private fun savejobDetailsInDatabase(mlOutput:String){
        dialogBox("Saving Data in Database","Please wait")
        val sharedPreferences = requireContext().getSharedPreferences("MyPrefs", Context.MODE_PRIVATE)
        val scoreReceived = sharedPreferences.getString("testScore","")!!
        var jobData = JobDataModel(userName, uid, email, jobType, et1.text.toString(), et2.text.toString(), scoreReceived, et3.text.toString(), et4.text.toString(), et5.text.toString(), et6.text.toString(), et7.text.toString(), et8.text.toString(), et9.text.toString(), et10.text.toString(), mlOutput)
...
//                        resultTextView.text = "Prediction: ${myResponse.prediction}"
                        ...
                        if(statusFromML == "1"){
                            mlOutput = "Accepted"
                            savejobDetailsInDatabase(mlOutput)
                            postData(mlOutput)
                        }
